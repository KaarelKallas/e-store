...
<div class="flex justify-end font-[Acme]">
  <div class="flex items-center">
    <div>
      ...
      <input type="radio" value="One" v-model="picked" @click="picked = 'One'"/>
      <label class="text-[15px] text-[#FFEADC]" for="one">M</label>
      <input type="radio" value="Two" v-model="picked" @click="picked = 'Two'" />
      ...
      <!-- <p v-if="picked = 'Two'" class="text-[25px] mt-[52px] text-[#FFEADC]">{{products.data.price}}$</p> -->
